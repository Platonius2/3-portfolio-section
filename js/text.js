...
export class TextManager {
    ...
    loadFont() {
        ...
        loader.load(config.typeface, 
            ...
            (error) => {
                ...
                if (THREE.FontUtils && THREE.FontUtils.faces['helvetiker']) {
                    this.currentFont = THREE.FontUtils.faces['helvetiker'];
                    this.processTexts(this.currentFont);
                }
            }
        );
    }
    ...
    createText(trigger, idx, font) {
        try {
            ...
            const geometry = new THREE.TextGeometry(trigger.textContent, {
                font: font,
